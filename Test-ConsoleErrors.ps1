...
# extension logging starts with `[JLC]`
...
$output | Select-Object -ExpandProperty ConsoleEntries | Where-Object { $_.Text -Match 'commands|\[JLQ\]' } | ForEach-Object { Write-Host $_.Text }
